	...
	if (calcData[calc.items.profile]) {
		...
		var selectPoints = {
			...
			b2: {
				lamination01: [
					...
					[(calcData.b2.priceMin.width*calcData.b2.priceMin.height)/1000000, calcData.b2.priceMin.price],
					[1.96, 4530.23],
					[(calcData.b2.priceMax.width*calcData.b2.priceMax.height)/1000000, calcData.b2.priceMax.price]
				],
				other: [
					// [площадь окна, цена в евро]
					[(calcData.b2.priceMin.width*calcData.b2.priceMin.height)/1000000, calcData.b2.priceMin.price],
		...
		if (type_okna in selectPoints) {
			...
			// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
				...
				var DIVIDER = "..";
				console.log("DEBUG", "x = ", points[0][0], DIVIDER, points[1][0], DIVIDER, points[2][0]);
				console.log("DEBUG", "y = ", points[0][1], DIVIDER, points[1][1], DIVIDER, points[2][1]);
